...
class Ui_FE14UserConfigForm(QWidget):
    def __init__(self):
        ...
        self.randomize_skills_check_box = QCheckBox("Randomize Skills")
        self.randomize_skills_check_box.setChecked(True)
        ...
        combat_and_misc_layout.addWidget(self.randomize_skills_check_box)
        ...
        combat_and_misc_box = QGroupBox("Skills, Classes, and Misc.")
        ...
        grid.addWidget(combat_and_misc_box, 0, 2, 2, 1)
